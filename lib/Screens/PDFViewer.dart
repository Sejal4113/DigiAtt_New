...
class _PDFViewerState extends State<PDFViewer> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      }, label: Text('Assign Marks'),backgroundColor: Theme.of(context).colorScheme.primary,),
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              onPressed: () async {
                                if(FormKey.currentState!.validate()){
                                  ...
                                  Navigator.pop(context);
                                  snackbarKey.currentState!.showSnackBar(SnackBar(content: Text('Marks assigned')));
                                }
                              },
