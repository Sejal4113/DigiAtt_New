              ...
              return Column(
                ...
                children: [
                  Padding(
                   ...
                   Divider(thickness: 2,),
                   ListView.builder(shrinkWrap: true,itemCount: Tlist.length,itemBuilder: (context, index) {
                  ...
                  Divider(thickness: 2,),
                  ListView.builder(shrinkWrap: true,itemCount: Slist.length,itemBuilder: (context, index) {
